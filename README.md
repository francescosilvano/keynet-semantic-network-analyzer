...
- **`exports/full_analysis/`**: Complete analysis with all 24 keywords
...
**Data Collection** Posts are fetched from Bluesky API filtered by 24 climate keywords including green transition, CO2, global warming, renewable energy, loss of biodiversity, fossil fuels, and more (case-insensitive matching).
